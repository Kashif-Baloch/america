...
function FilterSection({ t }: { t: ReturnType<typeof useTranslations> }) {
...
function DropdownFilter({
  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      <button
        className={`flex items-center cursor-pointer px-3 py-2 rounded gap-2.5 bg-primary-blue/5 text-[#555555] text-base ${className}`}
...
function MultiDropdownFilter({
  ...
  return (
    <div className="relative md:min-w-[135px] max-md:w-max" ref={dropdownRef}>
      <button
        className="flex items-center cursor-pointer px-3 py-2 rounded gap-2.5 bg-primary-blue/5 text-[#555555] text-base md:min-w-[135px] max-md:w-max"
        onClick={() => setIsOpen(!isOpen)}
      >
