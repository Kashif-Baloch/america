  ...
  return (
    <div className="relative" ref={langDropdownRef}>
      <button
        ...
        className={cn(
          "flex items-center justify-center cursor-pointer  md:text-lg rounded-full border border-[#DADADA]  bg-transparent text-white h-12 hover:bg-white/10 md:min-w-[120px] max-md:px-3  w-full",
          className
        )}
      >
        <span className={`fi fi-${locale === "en" ? "us" : locale} size-4`} />
        <span
